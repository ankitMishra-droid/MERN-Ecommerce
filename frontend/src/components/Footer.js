    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div className="py-14 flex flex-col lg:flex-row justify-between gap-8 border-b border-gray-500">
        <div className="w-full max-lg:mx-auto flex flex-col sm:flex-row max-lg:items-center max-lg:justify-between gap-6 md:gap-12 lg:gap-24">
          <div className="">
            <h6 className="text-lg font-medium text-white mb-7 max-lg:text-center">About</h6>
            <ul className="flex flex-col max-lg:items-center gap-6">
              <li><Link to={"/contact-us"}
                  className="text-base font-normal max-lg:text-center text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">Contact Us</Link>
              </li>
              <li><Link to={"/about-us"}
                  className="text-base font-normal max-lg:text-center text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">About Us</Link>
              </li>
              {/* <li><Link to={"#"}
                  className="text-base font-normal max-lg:text-center text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">Pricing</Link>
              </li>
              <li><Link to={"#"}
          ...
          <div className="">
            ...
            <ul className="flex flex-col gap-6 max-lg:items-center">
              <li><Link to={"#"}
                  className="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">FAQs</Link>
              </li>
              <li><Link to={"#"}
                  ...
                  Start</Link></li>
              <li><Link to={"#"}
                  className="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">Documentation</Link>
              </li>
              <li><Link to={"#"}
            ...
            <form action="#" className="flex flex-col gap-5">
              ...
              <div className="flex flex-col min-[540px]:flex-row items-center justify-between gap-3">
                <div className="flex items-start black">
                  <input id="checked-checkbox" type="checkbox" value="checked"
                  ...
                  <label htmlFor="checked-checkbox" className="text-sm font-normal cursor-pointer text-gray-400">
                    I agree with <Link to={"#"} className="text-amber-500">Privacy Policy</Link> and <Link
                      to={"#"} className="text-amber-500">Terms of Condition</Link></label>
                </div>
      ...
      <div className="flex flex-col-reverse sm:flex-row items-center justify-between gap-5 pt-7">
        ...
        <Link to="/" className="">©MangalaMoments</Link> 2024, All rights reserved.
        </span>
