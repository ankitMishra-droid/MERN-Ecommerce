                ...
                return (
                  <SwiperSlide key={product?._id + index}>
                    <Link
                      ...
                      className="w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-auto shandow mt-10 mb-10 flex relative overflow-hidden rounded-lg border border-gray-100 md:bg-white bg-slate-200 flex-col md:flex-row shadow-md"
                    >
